      ...
      <div className="flex flex-col items-center gap-2 z-1">
        <div className="p-4 mb-4 max-w-[780px] mt-24">
          ...
          <h3 className="text-3xl mt-10 font-bold text-center">
            Automate tasks, enhance collaboration, and unlock new possibilities with intelligent <span className="text-[#976FFF]">AI Agents</span>.
          </h3>
        </div>
        <div className="flex flex-col">
          <button className="p-4 rounded text-white text-bold bg-[#482F8A]">
            Join AI Office
          </button>
        </div>
      </div>
