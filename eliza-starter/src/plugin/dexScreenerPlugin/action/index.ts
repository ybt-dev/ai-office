    ...
    examples = [
        [
            ...
            },
            {
                user: "{{system}}",
                content: {
                    text: "The current price of Ethereum (ETH) is $3,345.67 with a 24h trading volume of $9.87B. The liquidity pool holds $1.23B, and the price has changed +5.43% in the last 24 hours.",
        ...
        [
            ...
            },
            {
                user: "{{system}}",
                content: {
                    text: "Bitcoin (BTC) is currently trading at $102,567.89. There's $15.23B in liquidity, with a 24h volume of $25.87B. The price is up 2.15% in the last 24 hours.",
                    action: "GET_TOKEN_PRICE"
                }
            }
        ],
        ...
        [
            ...
            },
            {
                user: "{{system}}",
                content: {
                    text: "Solana (SOL) is trading at $250.45, showing strong momentum with an 8.75% increase in the last 24 hours. The liquidity stands at $3.23B with a 24h trading volume of $987.54M.",
                    action: "GET_TOKEN_PRICE"
                }
            }
        ],
